...
test('Scan Quotation Status for Pending', async ({ page }) => {
  ...
  await page.getByRole('option', { name: 'Quotation Approved' }).click();
  ...
  while (true) {
    ...
    for (const row of rows) {
      ...
      if (status) {
        ...
        if (statusText === 'quotation pending') {
          console.log(`Quotation Status: Quotation Pending - PASS`);
          passCount++;
        } else if (statusText === 'quotation approved') {
          console.log(`Quotation Status: Quotation Approved - PASS`);
          passCount++;
        } else if (statusText === 'quotation cancelled') {
          console.log(`Quotation Status: Quotation Cancelled - PASS`);
          passCount++;
        }
      }
    }
  ...
  console.log(`Total PASS (Quotation Approved): ${passCount}`);
  console.log(`Total PASS (Quotation Cancelled): ${passCount}`);
  }
);
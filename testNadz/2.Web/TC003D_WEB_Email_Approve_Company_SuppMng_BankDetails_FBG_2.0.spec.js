...
test('TC004A - Web Admin Approve Company Supplier Management', async () => {
  ...
  const screenshotsDir = path.resolve('./screenshots/web_Email_Company_approve_supplier_management_BankDetails');
  ...
  try {
    ...
    const writeSuccess = await writeResultToExcel(
      'WEB_AdminLogin',
      'TC003D',
      'Web_Admin_Email_Company_Approve_SupplierManagement_BankDetails_HappyFlow',
      timestamp,
      testResult,
      screenshotPath
    );

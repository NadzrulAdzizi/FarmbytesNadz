...
test('TC004A - Web Admin Approve Company Supplier Management', async () => {
  ...
  const screenshotsDir = path.resolve('./screenshots/web_AppleId_Company_approve_supplier_management_BankDetails');
...
*/
    ...
    const writeSuccess = await writeResultToExcel(
      'WEB_AdminLogin',
      'TC004D',
      'Web_Admin_AppleId_Company_Approve_SupplierManagement_BankDetails_HappyFlow',
      timestamp,
      testResult,
      screenshotPath
    );

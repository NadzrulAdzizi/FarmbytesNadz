...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_iOS_TC0015B_SelfDropOff_EditCropQuantityBeforeSubmit');
  ...
  try {
    ...
    const writeSuccess = await writeResultToExcel(
      ...
      'TC0015B',
      'iOS_SelfDropOff_EditCropQuantityBeforeSubmit_HappyFlow',
      testResult,
      screenshotPath,
      'Mobile_iOS'
    );

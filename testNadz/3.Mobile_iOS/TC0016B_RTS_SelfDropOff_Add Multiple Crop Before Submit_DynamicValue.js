...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_iOS_TC0016B_SelfDropOff_AddMultipleCropBeforeSubmit');
  ...
  try {
    ...
    const writeSuccess = await writeResultToExcel(
      ...
      'TC0016B',
      'iOS_SelfDropOff_AddMultipleCropBeforeSubmit_HappyFlow',
      testResult,
      screenshotPath,
      'Mobile_iOS'
    );

...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_iOS_SignUp_FB_Individual');
  ...
  try {
    ...
    // ============================================
    // TC001: iOS INDIVIDUAL SIGN UP WITH FACEBOOK
    // ============================================
...
// Replace your OTP section with this:
    ...
    await writeResultToExcel(
      'iOS_Individual_SignUp_FB',
      'TC003',
      'iOS_Individual_SignUp_FB_HappyFlow',
      testResult,
      screenshotPath,
      'iOS_SignUp'
    );

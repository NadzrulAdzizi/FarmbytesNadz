...
async function writeResultToExcel(moduleid, tcId, testScenario, result, screenshotPath, sheetName = 'Gmail_Login') {
...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_Android_Gmail_Login');

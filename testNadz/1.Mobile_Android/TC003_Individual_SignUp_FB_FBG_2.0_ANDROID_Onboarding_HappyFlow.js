...
async function writeResultToExcel(moduleid, tcId, testScenario, result, screenshotPath, sheetName = 'Facebook_SignUp_KYC_Individual') {
...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_Android_Facebook_SignUp_KYC_Individual');
  ...
  try {
    ...
    // Step 34: Final success verification
    console.log("Step 34: Final success verification");
    ...
    await writeResultToExcel(
      'Android_Facebook_SignUp_KYC_Individual',
      'TC003',
      'Android_Facebook_Individual_SignUp_KYC_HappyFlow',
      testResult,
      screenshotPath, // This will now always contain a valid screenshot path
      'Facebook_SignUp_KYC_Individual'
    );

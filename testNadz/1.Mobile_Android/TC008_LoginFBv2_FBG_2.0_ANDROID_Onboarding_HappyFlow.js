...
async function writeResultToExcel(moduleid, tcId, testScenario, result, screenshotPath, sheetName = 'Facebook_Loginv2') {
...
async function main() {
  ...
  const screenshotDir = path.resolve('./screenshots/Mobile_Android_Facebook_Loginv2');
  ...
  try {
   ...
   // Step 2: Final success verification
    console.log("Step 2: Final success verification");
    ...
    await writeResultToExcel(
      ...
      'TC008',
      'Android_Facebook_Loginv2_HappyFlow',
      testResult,
